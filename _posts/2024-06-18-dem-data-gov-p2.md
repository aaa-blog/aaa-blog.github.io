...
Over the years, number of thought leaders have created & shared impeccable body of knowledge with practitioners. Few examples would be - [Non-Invasive Data Governance Framework](https://kikconsulting.com/ "Non-Invasive Data Governance Framework") or the one from [NASCIO](https://www.nascio.org/ "NASCIO"). May be topic for blog for another day :)
